...
def _run_summary_message_label(extra: dict[str, Any]) -> str:
    ...
    return _compact_label(
        ...
        f"status={extra.get('final_status', '-')}",
        f"provider={extra.get('provider', '-')}",
        f"model={extra.get('model', '-')}",
        f"prompt={extra.get('prompt_chars', '-')}",
        f"msgs={extra.get('message_count', '-')}",
        f"tools={extra.get('tool_count', '-')}",
        _compact_ms(extra.get("first_token_ms"), label="first"),
        _compact_ms(extra.get("llm_total_ms"), label="llm"),
        _compact_ms(extra.get("approval_wait_ms"), label="approve"),
        _compact_ms(extra.get("total_ms"), label="total"),
        f"requested={extra.get('tool_requested', '-')}",
        f"executed={extra.get('tool_executed', '-')}",
        f"confirmed={extra.get('tool_confirmed', '-')}",
        f"rejected={extra.get('tool_rejected', '-')}",
        f"guardrail={extra.get('guardrail_rejected', '-')}",
        f"error={extra.get('error', '-')}",
    )
